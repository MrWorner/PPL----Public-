//func_Step3_PoliceWave_Spawn_HELI
...
//player sidechat format ["func_Step3_PoliceWave_Spawn_HELI = %1",_CHOSEN_POLICECAR];
...
_POLICECAR = createVehicle [_CHOSEN_POLICECAR, _PositionMarker,[], 0, "FLY"];
_POLICECAR setPos [getPos _POLICECAR select 0, getPos _POLICECAR select 1, 2500];
//player moveincargo _POLICECAR;
...
//player sidechat format ["func_Step3_PoliceWave_Spawn_HELI: Risk level %1, units are spawning! _CHOSEN_UnitsArray: %2",POLICE_RISK_LEVEL, _CHOSEN_UnitsArray];
sleep 1;
