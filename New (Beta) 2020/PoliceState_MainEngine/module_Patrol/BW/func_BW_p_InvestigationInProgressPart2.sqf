...
_MarkerCHosen = _this select 2;
	...
	//player globalchat format ["|---func_BW_p_InvestigationInProgress: Added new INVESTIGATION waypoints for %1 TARGET MARKER: %2", _group,_MarkerCHosen];
