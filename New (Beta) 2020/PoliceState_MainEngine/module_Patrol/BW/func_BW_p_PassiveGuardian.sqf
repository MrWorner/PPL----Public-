//func_BW_p_PassiveGuardian.sqf
private["_BWLeader","_group","_Position", "_waypoint"];
...
[name leader _group + format ["%1",round random 1000], _Position, "GUARDIAN"] spawn func_BW_WorkMarker; //FOR TESTING
