...
Count_KilledMedics = Count_KilledMedics + 1;
Count_TOTAL_DEAD_BODIES = Count_TOTAL_DEAD_BODIES + 1;
if(SHOWTMessageLVL2)then{player sidechat format ["|---REMOVED FROM Array_MedicalPersonal: %1", _SUBJECT];};// MESSAGE LVL2
//hintc "REMOVED FROM Array_MedicalPersonal!";
