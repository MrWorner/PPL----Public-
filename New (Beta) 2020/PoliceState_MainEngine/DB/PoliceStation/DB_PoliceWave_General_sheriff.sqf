//DB_PoliceWave_General_sheriff.sqf
//_Subject setVariable ["MyWepRole",];
// _Lv_SAMPLE =
// [
 	 // [
...
[
	 ...
	 [
		...
		"CVPI_TrooperSL_Patrol",[1,1,0,0], //CAR type, [driver,crew size (only with DEFAULT SKIN! NOT TOTAL NUMBER),x Gunners,Commander]	
		"lae_chrn_plce1", //Driver gunner commander SKIN
		"lae_chrn_plce1", //Crew
		[
		],
	 ...
	 [
		2, 0, //COST of current pack, SetVar Police_RiskLevel_BonusScore
		"CVPI_Trooper_Patrol",[1,1,0,0], //CAR type, [driver,crew size (only with DEFAULT SKIN! NOT TOTAL NUMBER),x Gunners,Commander]	
		"lae_chrn_plce1", //Driver gunner commander SKIN
		"lae_chrn_plce1", //Crew
		[
		],
...
[	
	//AMERICAN POLICE CAR PACK
	 [
		...
		"CVPI_TrooperSL_Patrol",[1,3,0,0], //CAR type, [driver,crew size (only with DEFAULT SKIN! NOT TOTAL NUMBER),x Gunners,Commander]	
		"lae_chrn_plce1", //Driver gunner commander SKIN
		"lae_chrn_plce1", //Crew
		[
		],
	 ...
	 [
		4, 0, //COST of current pack, SetVar Police_RiskLevel_BonusScore
		"CVPI_Trooper_Patrol",[1,3,0,0], //CAR type, [driver,crew size (only with DEFAULT SKIN! NOT TOTAL NUMBER),x Gunners,Commander]	
		"lae_chrn_plce1", //Driver gunner commander SKIN
		"lae_chrn_plce1", //Crew
		[
		],
...
[
	//AMERICAN POLICE CAR PACK
	 [
		...
		"CVPI_TrooperSL_Patrol",[1,3,0,0], //CAR type, [driver,crew size (only with DEFAULT SKIN! NOT TOTAL NUMBER),x Gunners,Commander]	
		"FDF_SJ_M05_2", //Driver gunner commander SKIN
		"FDF_SJ_M05_2", //Crew
		[
		],
		[
	 ...
	 [
		16, 2, //COST of current pack, SetVar Police_RiskLevel_BonusScore
		"BRDM2IMPPolicePatrol_CDF_IND",[1,6,0,1], //CAR type, [driver,crew size (only with DEFAULT SKIN! NOT TOTAL NUMBER),x Gunners,Commander]	
		"FDF_SJ_M05_2", //Driver gunner commander SKIN
		"FDF_SJ_M05_2", //Crew
		[
		],
...
//COMPLETE BUNDLE
PoliceWaveArray_General_sheriff = [_bonus, _Lv_1,_Lv_2,_Lv_3,_Lv_4,_Lv_5,_Lv_6];