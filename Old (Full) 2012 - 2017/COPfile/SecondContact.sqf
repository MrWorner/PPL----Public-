...
if(!(_cop in (_x getVariable "CopsKnowMe"))and(((_Knowledge > 0.45)or(_Knowledge2 > 0.25))and((_cop distance _x) <300)and!(_x in RestrainedPeople)))then{
if(_Voice == 1)then{
...
// if!(alive _x) exitwith{};
 ...
 [_cop,_Voice,_x] call FunctionPoliceChase;
 [] execVM "ReadyForActions.sqf";
  sleep 1;
